...
//                    }
                    ...
                    if ($display_show_status) {
                        ...
                        switch ($field) {
                            case 'textarea':
                                ...
                                $display .= '<textarea title="' . $name . '" ' . $disabled . ' class="upme-input ' . $required_class . ' '.$custom_editor_styles.' " name="' . $meta . '-' . $id . '" id="' . $meta . '-' . $id . '">' . get_user_meta($id,$meta, true) . '</textarea>';
                                break;
    ...
    public function show_register_form($sidebar_class=null, $redirect_to=null, $user_role=null, $registration_form_name=null,$display_login=null ) {
        ...
        if (!isset($upme_register->registered) || $upme_register->registered != 1) {
            ...
            $custom_reg_fields = $this->manage_custom_registration_fields($custom_registration_fields_params);
...
//    }
    ...
    public function manage_custom_registration_fields($params){
        global $upme_options;
        extract($params);
        ...
        foreach ($profile_fields as $key => $field) {
            ...
            /* separator */
            if ($type == 'separator' && $deleted == 0 && $private == 0 && isset($profile_fields[$key]['show_in_register']) && $array[$key]['show_in_register'] == 1) {
