...
abstract class Awesome_Post {
    ...
    */
    ...
    /**
     * Validation rules for model Employer
     * Each field on front-end MUST contains model name, for example 'employer-name' is field for Employer' name
    ...
    public static function display_empty_model_message($count, $model, $hint){
        $hidden = $count > 0 ? 'visibilty:hidden;opacity:0;display:none;' : '';
