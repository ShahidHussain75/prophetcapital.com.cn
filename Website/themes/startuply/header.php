...
<li class="menu-item">
<?php if (ICL_LANGUAGE_CODE == 'en') {  ?><a href="<?php echo wp_logout_url('$index.php'); ?>">Logout</a>
<?php } else { ?><a href="<?php echo wp_logout_url('$index.php'); ?>">退出</a>  
<?php } ?>
</li>
<li class="menu-item featured">
<?php if (ICL_LANGUAGE_CODE == 'en') {  ?>
<a class="user-profile base_clr_txt" href="<?php echo get_page_link(4271); ?>">VIP ZONE</a><?php } else { ?><a class="user-profile base_clr_txt" href="<?php echo get_page_link(4271); ?>">客户专区</a><?php } ?>
</li>
							</ul>
...
<?php } else { ?>
<?php wp_nav_menu( array( 'theme_location' => 'Inpage_menu', 'menu_class' => 'navigation-bar navigation-bar-left', 'fallback_cb' => 'startuply_default_menu', 'items_wrap' => startuply_edd_cart_wrap(), 'walker' => new wp_bootstrap_navwalker() ) ); ?>	
              <?php } ?>  
					</div>
				</div>
			</div>
