...
function vsc_testimonials_slider($atts, $content = null) {
	...
	$content_block .= '<div class="col-sm-12">';
	...
	foreach ($testimonial_ids as $tid) {
		$content_block .= '<li data-id="' . $tid . '"><div class="testimonial resp-center clearfix">' . do_shortcode("[vsc-testimonial id=" . $tid . " desc=true]") . "/div></li>";
	}

	$content_block .= '</ul></div>';

	$controls_block  = '<div id="feedback-controls" class="section light">';
	$controls_block .= '<div class="container">';
	$controls_block .= '<div class="col-my-10">';
	$controls_block .= '<div class="flex-manual">';

	foreach ($testimonial_ids as $tid) {
		$controls_block .= '<div data-href="' . $tid . '" class="col-my-2 wrap"><div class="switch">' . do_shortcode("[vsc-testimonial id=" . $tid . " photo=true]") . "</div></div>";
	}

	$controls_block .= '</div></div></div></div></div></div></div></section>';
