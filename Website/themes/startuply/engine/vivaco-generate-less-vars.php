...
function vivaco_generate_less_vars() {
	...
	$vivaco_base_color = !empty($options['vivaco_base_color']) ? $options['vivaco_base_color'] : '#b81c22';
	...
	*/
	...
	$main_menu_active_color = !empty($options['main_menu_active_color']) ? $options['main_menu_active_color'] : '#b81c22';
	...
	*/
	...
	$sticky_menu_active_color = !empty($options['sticky_menu_active_color']) ? $options['sticky_menu_active_color'] : '#b81c22';
...
*/
	...
	$subfooter_linkhover_color = isset($options['subfooter_linkhover_color']) ? $options['subfooter_linkhover_color'] : '#b81c22';
	...
	$subheader_bg_color = isset($options['subheader_bg_color']) ? $options['subheader_bg_color'] : '#b81c22';
    ...
    if(!empty($page_to_display)) {
      ...
      foreach ($page_to_display as $key => $page) {
        ...
        $main_menu_text_color = !empty($page_options['vivaco_menu_text_color'][0]) ? $page_options['vivaco_menu_text_color'][0] : '#333333';
      	$main_menu_active_color = !empty($page_options['vivaco_menu_active_color'][0]) ? $page_options['vivaco_menu_active_color'][0] : '#b81c22';
