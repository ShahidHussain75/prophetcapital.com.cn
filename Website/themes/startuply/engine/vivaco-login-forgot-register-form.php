...
<h4 class="text-center"><?php if (ICL_LANGUAGE_CODE == 'en') {  ?>Existing user<?php } else { ?>已注册用户<?php } ?>
</h4>
				...
				<div class="form form-overlay">
					...
					<div class="form-group col-xs-12">
						<span class="wpcf7-form-control-wrap log_login">
							<input type="text" name="log_login" value="<?php echo(isset($_POST['log_login']) ? $_POST['log_login'] : null); ?>" placeholder="<?php if (ICL_LANGUAGE_CODE == 'en') {  ?>Login<?php } else { ?>登录名<?php } ?>" class="wpcf7-form-control form-control"  aria-required="true" aria-invalid="false" required  tabindex="1">
						</span>
					...
					<div class="form-group col-xs-12">
						<span class="wpcf7-form-control-wrap log_password">
							<input type="password" name="log_password" value="<?php echo(isset($_POST['log_password']) ? $_POST['log_password'] : null); ?>" placeholder="<?php if (ICL_LANGUAGE_CODE == 'en') {  ?>Password<?php } else { ?>密码<?php } ?>" class="wpcf7-form-control form-control" aria-required="true" aria-invalid="false" required  tabindex="2">
						</span>
					...
					<div class="form-group col-xs-12">
						...
						<label for="log_remember"><?php if (ICL_LANGUAGE_CODE == 'en') {  ?>Remember Me<?php } else { ?>记住我<?php } ?></label>
					</div>

					<div class="form-group col-xs-12">
						<input type="submit" value="<?php if (ICL_LANGUAGE_CODE == 'en') {  ?>Login<?php } else { ?>登录<?php } ?>" name="log_submit" class="wpcf7-form-control wpcf7-submit btn base_clr_bg btn-solid"  tabindex="4">
					</div>
					...
					<div class="forgot-link text-center"><a href="#"><?php if (ICL_LANGUAGE_CODE == 'en') {  ?>Forgot Password<?php } else { ?>忘记密码<?php } ?></a></div>
				</div>
			</form>
		</div>

		<div class="vivaco-form hide" id="forgot-form">
			<h4 class="text-center"><?php if (ICL_LANGUAGE_CODE == 'en') {  ?>Forgot Password<?php } else { ?>忘记密码<?php } ?></h4>
				...
				<div class="form form-overlay">
					<div class="form-group col-xs-12">
						<span class="wpcf7-form-control-wrap user_login">
							<input type="text" name="user_login" value="<?php echo(isset($_POST['user_login']) ? $_POST['user_login'] : null); ?>" placeholder="<?php if (ICL_LANGUAGE_CODE == 'en') {  ?>Enter your email to reset your password.<?php } else { ?>输入邮箱重置密码<?php } ?>" class="wpcf7-form-control form-control"  aria-required="true" aria-invalid="false" required  tabindex="1001">
						</span>
					</div>

					<div class="form-group col-xs-12">
						<input type="submit" value="<?php if (ICL_LANGUAGE_CODE == 'en') {  ?>Reset Password<?php } else { ?>重设密码<?php } ?>" name="for_submit" class="wpcf7-form-control wpcf7-submit btn base_clr_bg btn-solid"  tabindex="1002">
					</div>
					...
					<div class="forgot-link text-center"><a href="#">&larr; <?php if (ICL_LANGUAGE_CODE == 'en') {  ?>Back to login<?php } else { ?>返回登陆<?php } ?></a></div>
				...
				<div class="form form-overlay">
					...
					<div class="form-group col-xs-12">
						<span class="wpcf7-form-control-wrap reg_fullname">
							<input type="text" name="reg_fullname" value="<?php echo(isset($_POST['reg_fullname']) ? $_POST['reg_fullname'] : null); ?>" placeholder="<?php if (ICL_LANGUAGE_CODE == 'en') {  ?>Fullname<?php } else { ?>名称<?php } ?>" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control" aria-invalid="false"  tabindex="2001">
						</span>
					...
					<div class="form-group col-xs-12">
						<span class="wpcf7-form-control-wrap reg_email">
							<input type="text" name="reg_email" value="<?php echo(isset($_POST['reg_email']) ? $_POST['reg_email'] : null); ?>" placeholder="<?php if (ICL_LANGUAGE_CODE == 'en') {  ?>Email<?php } else { ?>邮箱<?php } ?>" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control email" aria-required="true" aria-invalid="false" required  tabindex="2002">
						</span>
					...
					<div class="form-group col-xs-12">
						<span class="wpcf7-form-control-wrap reg_password">
							<input type="password" name="reg_password" value="<?php echo(isset($_POST['reg_password']) ? $_POST['reg_password'] : null); ?>" placeholder="<?php if (ICL_LANGUAGE_CODE == 'en') {  ?>Password<?php } else { ?>密码<?php } ?>" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control password" aria-required="true" aria-invalid="false" required  tabindex="2003">
						</span>
					...
					<div class="form-group col-xs-12">
						<span class="wpcf7-form-control-wrap reg_password_repeat">
							<input type="password" name="reg_password_repeat" value="<?php echo(isset($_POST['reg_password_repeat']) ? $_POST['reg_password_repeat'] : null); ?>" placeholder="<?php if (ICL_LANGUAGE_CODE == 'en') {  ?>Repeat password<?php } else { ?>再输入密码<?php } ?>" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control password" aria-required="true" aria-invalid="false" required  tabindex="2004">
						</span>
						<?php echo(!empty($errors['reg_password_repeat']) ? '<span role="alert" class="wpcf7-not-valid-tip">'.$errors['reg_password_repeat'].'</span>' : ''); ?>
					</div>

					<div class="form-group col-xs-12">
						<input type="submit" value="<?php if (ICL_LANGUAGE_CODE == 'en') {  ?>Register<?php } else { ?>注册<?php } ?>" name="reg_submit" class="wpcf7-form-control wpcf7-submit btn base_clr_bg btn-solid"  tabindex="2005">
					</div>
